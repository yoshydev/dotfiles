export PATH=$HOME/.nodebrew/current/bin:$HOME/.composer/vendor/bin:$HOME/.rbenv/bin:$HOME/.pyenv/shims:$HOME/.local/bin:/usr/local/opt/openssl/bin:/usr/local/opt/postgresql@9.6/bin:$PATH
